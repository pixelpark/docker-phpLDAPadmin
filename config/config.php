...
$servers->setValue('server', 'name', 'SFP Directory Server 01');
...
$servers->setValue('server', 'host', 'ldap://ds01-sfp.pixelpark.net/');
#$servers->setValue('server','host','ldaps://ldap.pixelpark.com/')
...
#$servers->newServer('sfp-ds');
$servers->newServer('ldap_pla');
$servers->setValue('server', 'name', 'SFP Directory Server 02');
$servers->setValue('server', 'host', 'ldap://ds02-sfp.pixelpark.net');
#$servers->setValue('server','port',389);
#$servers->setValue('server','base',array(''));
